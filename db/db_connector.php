...
$db_user = 'root';
$db_password = '';
$db_name = 'urldb'; // Changed the database name variable

$conn = mysqli_connect($db_server, $db_user, $db_password, ''); // Connecting to MySQL without selecting a database initially
